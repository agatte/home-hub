...
PC Agent (supervised on the dev machine only, 2026-04-19+)
   ...
   │                            (Stremio/media playback-active detector via MPRIS/PipeWire; emits device=latitude)
