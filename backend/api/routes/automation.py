...
async def get_schedule(request: Request) -> dict:
    ...
    return {
        "weekday": {
            ...
            "away_start_hour": sc.weekday.away_start_hour,
            "away_end_hour": sc.weekday.away_end_hour,
        ...
        "weekend": {
            ...
            "away_start_hour": sc.weekend.away_start_hour,
            "away_end_hour": sc.weekend.away_end_hour,
