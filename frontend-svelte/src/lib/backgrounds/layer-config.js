...
export const LAYER_CONFIGS = {
  working: [
    ...
    // Far city — slow scroll, anchored to bottom, covers lower 60%
    { src: '/backgrounds/working/buildings-far.png', duration: 90, opacity: 0.7, zIndex: 1,
      sizing: 'tile', anchor: 'bottom', height: '65%' },
    // Near buildings — medium scroll, lower 55%
    { src: '/backgrounds/working/buildings-near.png', duration: 50, opacity: 0.85, zIndex: 2,
      sizing: 'tile', anchor: 'bottom', height: '50%' },
    // Street level — fastest scroll, lower 45%
    { src: '/backgrounds/working/street.png', duration: 30, opacity: 1, zIndex: 3,
      sizing: 'tile', anchor: 'bottom', height: '45%' },
  ],
}
